    ...
    >
      ...
      >
        <path
          ...
          d="M6.75 7.5l-.503 8.043A2 2 0 008.24 17.67h7.52a2 2 0 001.992-2.127L17.25 7.5m-10.5 0h10.5M6.75 7.5l.5-2.958A2 2 0 09.232 3h5.536a2 2 0 011.982 1.542l.5 2.958m-7.25 0V9a3 3 0 006 0V7.5"
        />
      </svg>
      <span>Cart</span>
      {totalQuantity > 0 ? (
